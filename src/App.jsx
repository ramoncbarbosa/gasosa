    ...
    <div className="bg-purple-800 w-full h-screen">
      <div className='flex flex-col items-center justify-center'>
        ...
        <div className='flex flex-col items-center'>
          ...
          <input className='w-full max-w-md rounded-lg mb-4 px-4 py-2' type="number" placeholder='0' onChange={(event) => setEtanol(event.target.value)}></input>
  
          <label className='text-white'>Preço Litro da Gasolina R$</label>
          <input className='w-full max-w-md rounded-lg mb-4 px-4 py-2' type="number" placeholder='0' onChange={(event) => setGasolina(event.target.value)}></input>
